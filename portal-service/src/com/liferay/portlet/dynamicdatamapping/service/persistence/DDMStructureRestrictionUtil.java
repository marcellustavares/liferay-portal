...
/**
 * The persistence utility for the d d m structure restriction service. This utility wraps {@link com.liferay.portlet.dynamicdatamapping.service.persistence.impl.DDMStructureRestrictionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class DDMStructureRestrictionUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(ddmStructureRestriction);
	}
	 ...
	 */
	public static List<DDMStructureRestriction> findWithDynamicQuery(
	 ...
	 */
	public static DDMStructureRestriction update(
		DDMStructureRestriction ddmStructureRestriction) {
		return getPersistence().update(ddmStructureRestriction);
	}
	...
	public static DDMStructureRestriction update(
		...
		return getPersistence().update(ddmStructureRestriction, serviceContext);
	}
	...
	*/
	public static List<DDMStructureRestriction> findByC_C(long classNameId,
		long classPK) {
	...
	*/
	public static DDMStructureRestriction findByC_C_First(long classNameId,
		long classPK,
		OrderByComparator<DDMStructureRestriction> orderByComparator)
	...
	*/
	public static DDMStructureRestriction fetchByC_C_First(long classNameId,
		long classPK,
		OrderByComparator<DDMStructureRestriction> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchStructureRestrictionException if a matching d d m structure restriction could not be found
	*/
	public static DDMStructureRestriction findByC_C_Last(long classNameId,
		long classPK,
		OrderByComparator<DDMStructureRestriction> orderByComparator)
		throws com.liferay.portlet.dynamicdatamapping.NoSuchStructureRestrictionException {
		return getPersistence()
	...
	*/
	public static DDMStructureRestriction fetchByC_C_Last(long classNameId,
		long classPK,
		OrderByComparator<DDMStructureRestriction> orderByComparator) {
		return getPersistence()
	...
	*/
	public static DDMStructureRestriction[] findByC_C_PrevAndNext(
		long structureRestrictionId, long classNameId, long classPK,
		OrderByComparator<DDMStructureRestriction> orderByComparator)
		throws com.liferay.portlet.dynamicdatamapping.NoSuchStructureRestrictionException {
		return getPersistence()
				   .findByC_C_PrevAndNext(structureRestrictionId, classNameId,
	...
	* @throws NoSuchStructureRestrictionException if a matching d d m structure restriction could not be found
	*/
	public static DDMStructureRestriction findByC_C_S(long classNameId,
	...
	*/
	public static DDMStructureRestriction fetchByC_C_S(long classNameId,
		long classPK, long structureId) {
	...
	*/
	public static DDMStructureRestriction fetchByC_C_S(long classNameId,
		long classPK, long structureId, boolean retrieveFromCache) {
		return getPersistence()
	...
	*/
	public static DDMStructureRestriction removeByC_C_S(long classNameId,
		long classPK, long structureId)
		throws com.liferay.portlet.dynamicdatamapping.NoSuchStructureRestrictionException {
	...
	*/
	public static void cacheResult(
		DDMStructureRestriction ddmStructureRestriction) {
		getPersistence().cacheResult(ddmStructureRestriction);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(ddmStructureRestrictions);
	}
	...
	*/
	public static DDMStructureRestriction create(long structureRestrictionId) {
		return getPersistence().create(structureRestrictionId);
	}
	...
	* @throws NoSuchStructureRestrictionException if a d d m structure restriction with the primary key could not be found
	*/
	public static DDMStructureRestriction remove(long structureRestrictionId)
		throws com.liferay.portlet.dynamicdatamapping.NoSuchStructureRestrictionException {
		return getPersistence().remove(structureRestrictionId);
	}

	public static DDMStructureRestriction updateImpl(
		DDMStructureRestriction ddmStructureRestriction) {
		return getPersistence().updateImpl(ddmStructureRestriction);
	}
	...
	* @throws NoSuchStructureRestrictionException if a d d m structure restriction with the primary key could not be found
	*/
	public static DDMStructureRestriction findByPrimaryKey(
		long structureRestrictionId)
		throws com.liferay.portlet.dynamicdatamapping.NoSuchStructureRestrictionException {
		return getPersistence().findByPrimaryKey(structureRestrictionId);
	}
	...
	*/
	public static DDMStructureRestriction fetchByPrimaryKey(
		long structureRestrictionId) {
		return getPersistence().fetchByPrimaryKey(structureRestrictionId);
	}

	public static java.util.Map<java.io.Serializable, DDMStructureRestriction> fetchByPrimaryKeys(
	...
	*/
	public static List<DDMStructureRestriction> findAll() {
	...
	*/
	public static List<DDMStructureRestriction> findAll(int start, int end) {
	...
	*/
	...
	public static DDMStructureRestrictionPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (DDMStructureRestrictionPersistence)PortalBeanLocatorUtil.locate(DDMStructureRestrictionPersistence.class.getName());

			ReferenceRegistry.registerReference(DDMStructureRestrictionUtil.class,
				"_persistence");
		}
	 ...
	 */
	@Deprecated
	public void setPersistence(DDMStructureRestrictionPersistence persistence) {
	}

	private static DDMStructureRestrictionPersistence _persistence;
}