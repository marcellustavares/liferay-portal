...
public class DDMStructureLinkUtil {
	...
	* @return the matching d d m structure links
	*/
	public static List<DDMStructureLink> findByC_S(long classNameId,
		long structureId) {
		return getPersistence().findByC_S(classNameId, structureId);
	}
	...
	*/
	public static List<DDMStructureLink> findByC_S(long classNameId,
		...
		return getPersistence().findByC_S(classNameId, structureId, start, end);
	}
	...
	*/
	public static List<DDMStructureLink> findByC_S(long classNameId,
		...
		OrderByComparator<DDMStructureLink> orderByComparator) {
		return getPersistence()
				   .findByC_S(classNameId, structureId, start, end,
			orderByComparator);
	}
	...
	* @throws NoSuchStructureLinkException if a matching d d m structure link could not be found
	*/
	public static DDMStructureLink findByC_S_First(long classNameId,
		long structureId, OrderByComparator<DDMStructureLink> orderByComparator)
		throws com.liferay.portlet.dynamicdatamapping.NoSuchStructureLinkException {
		return getPersistence()
				   .findByC_S_First(classNameId, structureId, orderByComparator);
	}
	...
	* @return the first matching d d m structure link, or <code>null</code> if a matching d d m structure link could not be found
	*/
	public static DDMStructureLink fetchByC_S_First(long classNameId,
		long structureId, OrderByComparator<DDMStructureLink> orderByComparator) {
		return getPersistence()
				   .fetchByC_S_First(classNameId, structureId, orderByComparator);
	}
	...
	* @throws NoSuchStructureLinkException if a matching d d m structure link could not be found
	*/
	public static DDMStructureLink findByC_S_Last(long classNameId,
		long structureId, OrderByComparator<DDMStructureLink> orderByComparator)
		throws com.liferay.portlet.dynamicdatamapping.NoSuchStructureLinkException {
		return getPersistence()
				   .findByC_S_Last(classNameId, structureId, orderByComparator);
	}
	...
	* @return the last matching d d m structure link, or <code>null</code> if a matching d d m structure link could not be found
	*/
	public static DDMStructureLink fetchByC_S_Last(long classNameId,
		long structureId, OrderByComparator<DDMStructureLink> orderByComparator) {
		return getPersistence()
				   .fetchByC_S_Last(classNameId, structureId, orderByComparator);
	}
	...
	* @throws NoSuchStructureLinkException if a d d m structure link with the primary key could not be found
	*/
	public static DDMStructureLink[] findByC_S_PrevAndNext(
		long structureLinkId, long classNameId, long structureId,
		OrderByComparator<DDMStructureLink> orderByComparator)
		throws com.liferay.portlet.dynamicdatamapping.NoSuchStructureLinkException {
		return getPersistence()
				   .findByC_S_PrevAndNext(structureLinkId, classNameId,
	...
	* @param structureId the structure ID
	*/
	public static void removeByC_S(long classNameId, long structureId) {
		getPersistence().removeByC_S(classNameId, structureId);
	}
	...
	* @return the number of matching d d m structure links
	*/
	public static int countByC_S(long classNameId, long structureId) {
		return getPersistence().countByC_S(classNameId, structureId);
	}
