 ...
 */
public abstract class SearchResultUtilTestBase {
	...
	public void setUp() {
		...
		/*
		com.liferay.portal.kernel.search.DocumentImpl._INDEX_DATE_FORMAT_PATTERN
		*/
		PropsUtil.setProps(mockProps);

		/*
		com.liferay.portal.kernel.search.DocumentImpl._dateFormat
		*/
		new FastDateFormatFactoryUtil().setFastDateFormatFactory(
			mockFastDateFormatFactory);

		/*
		com.liferay.portal.util.PortalUtil.getClassName(long)
		*/
		new PortalUtil().setPortal(mockPortal);

		/*
		com.liferay.portlet.asset.AssetRendererFactoryRegistryUtil.
			getAssetRendererFactoryByClassName(String)
		 */
		new AssetRendererFactoryRegistryUtil().setAssetRendererFactoryRegistry(
			mockAssetRendererFactoryRegistry);

		/*
		com.liferay.portal.kernel.search.Indexer.getSummary(
			Document, Locale, String, PortletURL)
		 */
