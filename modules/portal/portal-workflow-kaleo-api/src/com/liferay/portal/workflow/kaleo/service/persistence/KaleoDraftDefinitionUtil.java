...
/**
 * The persistence utility for the kaleo draft definition service. This utility wraps {@link com.liferay.portal.workflow.kaleo.service.persistence.impl.KaleoDraftDefinitionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.liferay.portal.workflow.kaleo.service.persistence.impl.KaleoDraftDefinitionPersistenceImpl
 * @generated
 */
@ProviderType
public class KaleoDraftDefinitionUtil {
	...
	*/
	public static KaleoDraftDefinition findByCompanyId_First(long companyId,
		OrderByComparator<KaleoDraftDefinition> orderByComparator)
		throws com.liferay.portal.workflow.kaleo.exception.NoSuchDraftDefinitionException {
		return getPersistence()
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(KaleoDraftDefinitionUtil.class);

		_serviceTracker = new ServiceTracker<KaleoDraftDefinitionPersistence, KaleoDraftDefinitionPersistence>(bundle.getBundleContext(),
				KaleoDraftDefinitionPersistence.class, null);
