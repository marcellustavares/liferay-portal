...
import com.liferay.portal.workflow.kaleo.service.persistence.KaleoDraftDefinitionUtil;
...
public class KaleoDraftDefinitionPersistenceTest {
	...
	@Test(expected = NoSuchDraftDefinitionException.class)
	...
	protected OrderByComparator<KaleoDraftDefinition> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("KaleoDraftDefinition",
			...
			"modifiedDate", true, "name", true, "title", true, "content", true,
			"version", true, "draftVersion", true);
	}
	...
	public void testActionableDynamicQuery() throws Exception {
		...
		actionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod() {
				...
				public void performAction(Object object) {
					KaleoDraftDefinition kaleoDraftDefinition = (KaleoDraftDefinition)object;
