...
import com.liferay.portal.workflow.kaleo.model.impl.KaleoDraftDefinitionImpl;
import com.liferay.portal.workflow.kaleo.model.impl.KaleoDraftDefinitionModelImpl;
 ...
 * @see com.liferay.portal.workflow.kaleo.service.persistence.KaleoDraftDefinitionUtil
 * @generated
 */
@ProviderType
public class KaleoDraftDefinitionPersistenceImpl extends BasePersistenceImpl<KaleoDraftDefinition>
	 ...
	 * @throws com.liferay.portal.workflow.kaleo.NoSuchDraftDefinitionException if a matching kaleo draft definition could not be found
	 */
	@Override
	public KaleoDraftDefinition findByCompanyId_First(long companyId,
		OrderByComparator<KaleoDraftDefinition> orderByComparator)
		throws NoSuchDraftDefinitionException {
		...
		throw new NoSuchDraftDefinitionException(msg.toString());
	}
	 ...
	 * @throws com.liferay.portal.workflow.kaleo.NoSuchDraftDefinitionException if a kaleo draft definition with the primary key could not be found
	 */
	@Override
	...
	/**
	 * Returns the kaleo draft definition where companyId = &#63; and name = &#63; and version = &#63; and draftVersion = &#63; or throws a {@link com.liferay.portal.workflow.kaleo.NoSuchDraftDefinitionException} if it could not be found.
	 *
	 * @param companyId the company ID
	 * @param name the name
	 * @param version the version
	...
	public KaleoDraftDefinition findByC_N_V_D(long companyId, String name,
		int version, int draftVersion) throws NoSuchDraftDefinitionException {
	...
	protected void cacheUniqueFindersCache(
		KaleoDraftDefinition kaleoDraftDefinition, boolean isNew) {
		if (isNew) {
	...
	public KaleoDraftDefinition remove(Serializable primaryKey)
		...
		try {
			...
			if (kaleoDraftDefinition == null) {
				...
				throw new NoSuchDraftDefinitionException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}

			return remove(kaleoDraftDefinition);
		}
		catch (NoSuchDraftDefinitionException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public KaleoDraftDefinition updateImpl(
		...
		clearUniqueFindersCache((KaleoDraftDefinition)kaleoDraftDefinitionModelImpl);
		cacheUniqueFindersCache((KaleoDraftDefinition)kaleoDraftDefinitionModelImpl,
			isNew);
	...
	/**
	 * Returns the kaleo draft definition with the primary key or throws a {@link com.liferay.portal.workflow.kaleo.NoSuchDraftDefinitionException} if it could not be found.
	 *
	 * @param kaleoDraftDefinitionId the primary key of the kaleo draft definition
	 * @return the kaleo draft definition
	 * @throws com.liferay.portal.workflow.kaleo.NoSuchDraftDefinitionException if a kaleo draft definition with the primary key could not be found
