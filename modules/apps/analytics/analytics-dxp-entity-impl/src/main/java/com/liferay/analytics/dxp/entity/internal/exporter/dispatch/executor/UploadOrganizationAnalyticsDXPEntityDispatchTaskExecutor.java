...
@Component(
	immediate = true,
	property = {
		"dispatch.task.executor.name=" + UploadOrganizationAnalyticsDXPEntityDispatchTaskExecutor.KEY,
		"dispatch.task.executor.type=" + UploadOrganizationAnalyticsDXPEntityDispatchTaskExecutor.KEY
	},
	service = DispatchTaskExecutor.class
)
public class UploadOrganizationAnalyticsDXPEntityDispatchTaskExecutor
	...
	public void doExecute(
		...
		_uploadAnalyticsDXPEntityDispatchTaskExecutorHelper.doExecute(
			"organization-analytics-dxp-entities", dispatchTrigger,
