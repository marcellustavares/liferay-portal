...
@Component(
	immediate = true,
	property = "analytics.dxp.entity.page.retriever.class.name=com.liferay.portal.kernel.model.User",
	service = DXPEntityPageRetriever.class
)
public class UserPageRetriever implements DXPEntityPageRetriever {
