...
public class AnalyticsBatchClientImpl
		...
		try (CloseableHttpClient closeableHttpClient =
			...
			CloseableHttpResponse closeableHttpResponse =
				closeableHttpClient.execute(
					_setHeaders(
						companyId, Optional.of(resourceLastModifiedDate),
						httpGet));
	...
	public void uploadResource(
		...
		try (CloseableHttpClient closeableHttpClient =
			...
			CloseableHttpResponse closeableHttpResponse =
				closeableHttpClient.execute(
					_setHeaders(companyId, Optional.empty(), httpPost));
	...
	private HttpUriRequest _setHeaders(
		long companyId, Optional<Date> lastModifiedDateOptional,
		HttpUriRequest httpUriRequest) {

		AnalyticsConfiguration analyticsConfiguration =
			analyticsConfigurationTracker.getAnalyticsConfiguration(companyId);

		if (lastModifiedDateOptional.isPresent()) {
			httpUriRequest.setHeader(
				"Last-Modified",
				_lastModifiedHeaderDateFormatter.format(
					lastModifiedDateOptional.get()));
		}
	...
	private static final Format _lastModifiedHeaderDateFormatter =
