...
public class AnalyticsDeleteMessagePersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByGtM_C;
	private FinderPath _finderPathWithPaginationCountByGtM_C;
	 ...
	 */
	@Override
	public List<AnalyticsDeleteMessage> findByGtM_C(
	...
	public List<AnalyticsDeleteMessage> findByGtM_C(
		...
		return findByGtM_C(companyId, modifiedDate, start, end, null);
	}
	...
	public List<AnalyticsDeleteMessage> findByGtM_C(
		...
		finderPath = _finderPathWithPaginationFindByGtM_C;
		finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GTM_C_COMPANYID_2);

			boolean bindModifiedDate = false;

			if (modifiedDate == null) {
				sb.append(_FINDER_COLUMN_GTM_C_MODIFIEDDATE_1);
			}
			else {
				bindModifiedDate = true;

				sb.append(_FINDER_COLUMN_GTM_C_MODIFIEDDATE_2);
			}
	 ...
	 */
	@Override
	public AnalyticsDeleteMessage findByGtM_C_First(
			long companyId, Date modifiedDate,
			OrderByComparator<AnalyticsDeleteMessage> orderByComparator)
		throws NoSuchDeleteMessageException {

		AnalyticsDeleteMessage analyticsDeleteMessage = fetchByGtM_C_First(
	 ...
	 */
	@Override
	public AnalyticsDeleteMessage fetchByGtM_C_First(
		long companyId, Date modifiedDate,
		OrderByComparator<AnalyticsDeleteMessage> orderByComparator) {

		List<AnalyticsDeleteMessage> list = findByGtM_C(
	 ...
	 */
	@Override
	public AnalyticsDeleteMessage findByGtM_C_Last(
			long companyId, Date modifiedDate,
			OrderByComparator<AnalyticsDeleteMessage> orderByComparator)
		throws NoSuchDeleteMessageException {

		AnalyticsDeleteMessage analyticsDeleteMessage = fetchByGtM_C_Last(
			companyId, modifiedDate, orderByComparator);
	 ...
	 */
	@Override
	public AnalyticsDeleteMessage fetchByGtM_C_Last(
		long companyId, Date modifiedDate,
		OrderByComparator<AnalyticsDeleteMessage> orderByComparator) {

		int count = countByGtM_C(companyId, modifiedDate);
	 ...
	 */
	@Override
	public AnalyticsDeleteMessage[] findByGtM_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByGtM_C_PrevAndNext(
				session, analyticsDeleteMessage, companyId, modifiedDate,
				orderByComparator, true);

			array[1] = analyticsDeleteMessage;

			array[2] = getByGtM_C_PrevAndNext(
				session, analyticsDeleteMessage, companyId, modifiedDate,
	...
	protected AnalyticsDeleteMessage getByGtM_C_PrevAndNext(
		Session session, AnalyticsDeleteMessage analyticsDeleteMessage,
		long companyId, Date modifiedDate,
		OrderByComparator<AnalyticsDeleteMessage> orderByComparator,
		boolean previous) {
	...
	public int countByGtM_C(long companyId, Date modifiedDate) {
		FinderPath finderPath = _finderPathWithPaginationCountByGtM_C;
	...
	private static final String _FINDER_COLUMN_GTM_C_COMPANYID_2 =
		"analyticsDeleteMessage.companyId = ? AND ";

	private static final String _FINDER_COLUMN_GTM_C_MODIFIEDDATE_1 =
		"analyticsDeleteMessage.modifiedDate IS NULL";

	private static final String _FINDER_COLUMN_GTM_C_MODIFIEDDATE_2 =
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByGtM_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByGtM_C",
			new String[] {
		...
		_finderPathWithPaginationCountByGtM_C = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByGtM_C",
