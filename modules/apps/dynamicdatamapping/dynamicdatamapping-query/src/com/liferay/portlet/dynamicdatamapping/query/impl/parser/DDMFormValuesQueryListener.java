...
public interface DDMFormValuesQueryListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DDMFormValuesQueryParser#predicateEqualityEpression}.
	 * @param ctx the parse tree
	 */
	void enterPredicateEqualityEpression(@NotNull DDMFormValuesQueryParser.PredicateEqualityEpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link DDMFormValuesQueryParser#predicateEqualityEpression}.
	 * @param ctx the parse tree
	 */
	void exitPredicateEqualityEpression(@NotNull DDMFormValuesQueryParser.PredicateEqualityEpressionContext ctx);
