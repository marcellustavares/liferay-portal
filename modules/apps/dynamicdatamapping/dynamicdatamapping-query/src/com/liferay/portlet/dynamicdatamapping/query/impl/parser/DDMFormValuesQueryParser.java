...
public class DDMFormValuesQueryParser extends Parser {
	...
	public static final int
		...
		RULE_predicateAndExpression = 7, RULE_predicateEqualityEpression = 8, 
	...
	public static final String[] ruleNames = {
		...
		"predicateEqualityEpression", "attribute", "attributeType", "attributeValue", 
		"localeExpression"
	};
	...
	public static class PredicateAndExpressionContext extends ParserRuleContext {
		public List<PredicateEqualityEpressionContext> predicateEqualityEpression() {
			return getRuleContexts(PredicateEqualityEpressionContext.class);
		}
		public PredicateEqualityEpressionContext predicateEqualityEpression(int i) {
			return getRuleContext(PredicateEqualityEpressionContext.class,i);
		}
	...
	public final PredicateAndExpressionContext predicateAndExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(55); predicateEqualityEpression();
			setState(60);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__4) {
				...
				setState(57); predicateEqualityEpression();
				}
				}
				setState(62);
				_errHandler.sync(this);
	...
	public static class PredicateEqualityEpressionContext extends ParserRuleContext {
		...
		public PredicateEqualityEpressionContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_predicateEqualityEpression; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DDMFormValuesQueryListener ) ((DDMFormValuesQueryListener)listener).enterPredicateEqualityEpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DDMFormValuesQueryListener ) ((DDMFormValuesQueryListener)listener).exitPredicateEqualityEpression(this);
		}
	}

	public final PredicateEqualityEpressionContext predicateEqualityEpression() throws RecognitionException {
		PredicateEqualityEpressionContext _localctx = new PredicateEqualityEpressionContext(_ctx, getState());
		enterRule(_localctx, 16, RULE_predicateEqualityEpression);
		try {
			enterOuterAlt(_localctx, 1);
			{
