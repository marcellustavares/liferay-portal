AUI.add(
		...
		var FormBuilder = A.Component.create(
			{
				...
				prototype: {
					...
					_columnDestructor: function(column) {
						...
						if (A.instanceOf(value, Liferay.DDL.FormBuilderField)) {
							value.destroy();
						}
					...
					_onClickFieldType: function(event) {
						...
						if (!fieldType.get('disabled')) {
							...
							var field = new FormBuilderField(fieldType.get('defaultConfig'));
	...
	'',
	{
		requires: ['aui-form-builder', 'aui-form-builder-pages', 'liferay-ddl-form-builder-field', 'liferay-ddl-form-builder-layout-deserializer', 'liferay-ddl-form-builder-layout-visitor', 'liferay-ddm-form-field-types', 'liferay-ddm-form-renderer']
	}
);