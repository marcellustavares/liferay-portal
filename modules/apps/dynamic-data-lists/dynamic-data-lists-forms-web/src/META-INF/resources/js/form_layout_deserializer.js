AUI.add(
		...
		var LayoutDeserializer = A.Component.create(
			{
				...
				prototype: {
					...
					deserializeField: function(deserializedColumn, fieldName) {
						...
						// TODO - Field parent cannot be deserializedColumn
						...
						return (new FormBuilderField(fieldConfig)).render();
					},
	...
	'',
	{
		requires: ['aui-layout', 'liferay-ddl-form-builder-field', 'liferay-ddm-form-field-types', 'liferay-ddm-form-renderer-util']
	}
);