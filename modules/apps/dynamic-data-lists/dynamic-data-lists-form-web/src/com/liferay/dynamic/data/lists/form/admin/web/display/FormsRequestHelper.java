...
package com.liferay.dynamic.data.lists.form.admin.web.display;

import com.liferay.dynamic.data.lists.form.admin.web.search.RecordSetSearchTerms;
...
import com.liferay.portlet.dynamicdatamapping.io.DDMFormFieldTypesJSONSerializer;
...
public class FormsRequestHelper extends BaseRequestHelper {
	...
	public String getDDMFormFieldTypesJavaScriptModulesJSONArray()
		throws PortalException {

		List<DDMFormFieldType> ddmFormFieldTypes =
			DDMFormFieldTypeRegistryUtil.getDDMFormFieldTypes();

		Iterator<DDMFormFieldType> it = ddmFormFieldTypes.iterator();

		Set<String> modules = new HashSet<>();

		while (it.hasNext()) {
			DDMFormFieldType ddmFormFieldType = it.next();

			modules.add(ddmFormFieldType.getJavaScriptModule());
		}

		return StringUtil.merge(
			ArrayUtil.toStringArray(modules), StringPool.COMMA);
	}

	public JSONArray getDDMFormFieldTypesJSONArray() throws PortalException {
		return JSONFactoryUtil.createJSONArray(
			_ddmFormFieldTypesJSONSerializer.serialize(
				DDMFormFieldTypeRegistryUtil.getDDMFormFieldTypes()));
	}
