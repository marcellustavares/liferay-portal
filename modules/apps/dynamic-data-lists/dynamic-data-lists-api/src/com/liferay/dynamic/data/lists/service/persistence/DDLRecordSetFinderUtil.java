...
public class DDLRecordSetFinderUtil {
	...
	public static java.util.List<com.liferay.dynamic.data.lists.model.DDLRecordSet> filterFindByKeywords(
	...
	public static java.util.List<com.liferay.dynamic.data.lists.model.DDLRecordSet> filterFindByC_G_N_D_S(
	...
	public static java.util.List<com.liferay.dynamic.data.lists.model.DDLRecordSet> findByKeywords(
		long companyId, long groupId, java.lang.String keywords, int scope,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.lists.model.DDLRecordSet> orderByComparator) {
		return getFinder()
	...
	public static java.util.List<com.liferay.dynamic.data.lists.model.DDLRecordSet> findByC_G_N_D_S(
		long companyId, long groupId, java.lang.String name,
		java.lang.String description, int scope, boolean andOperator,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.lists.model.DDLRecordSet> orderByComparator) {
