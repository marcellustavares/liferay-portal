	...
	AUI().applyConfig(
		{
			groups: {
				...
				'soyutils-mock': {
					base: '/base/modules/apps/dynamic-data-mapping/dynamic-data-lists-web/src/META-INF/resources/',
					modules: {
					...
					root: '/base/modules/apps/dynamic-data-mapping/dynamic-data-lists-web/src/META-INF/resources/'
				},
