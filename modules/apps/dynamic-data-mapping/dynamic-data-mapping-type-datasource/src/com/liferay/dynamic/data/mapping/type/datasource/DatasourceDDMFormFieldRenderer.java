 ...
 */
@Component(
	immediate = true, property = "ddm.form.field.type.name=datasource",
	service = DDMFormFieldRenderer.class
)
public class DatasourceDDMFormFieldRenderer extends BaseDDMFormFieldRenderer {
	...
	protected void activate(Map<String, Object> properties) {
		_templateResource = getTemplateResource(
			"/META-INF/resources/datasource.soy");
	}
