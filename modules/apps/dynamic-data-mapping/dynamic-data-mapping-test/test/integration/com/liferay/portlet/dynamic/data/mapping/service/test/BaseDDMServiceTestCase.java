...
public class BaseDDMServiceTestCase extends 
	com.liferay.portlet.dynamicdatamapping.service.test.BaseDDMServiceTestCase {
	...
	protected DDMTemplate addTemplate(
		...
		return DDMTemplateLocalServiceUtil.addTemplate(
			...
			getDefaultLocaleMap(description), type, mode,
