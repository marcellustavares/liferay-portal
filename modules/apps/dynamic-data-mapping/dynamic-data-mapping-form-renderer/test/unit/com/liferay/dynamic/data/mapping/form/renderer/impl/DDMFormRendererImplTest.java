...
public class DDMFormRendererImplTest {
	...
	public void testCreateDDMFormFieldRenderingContextStackWithNoValues() {
		...
		DDMFormField contactDDMFormField = new DDMFormField(
			"contact", "separator");

		DDMFormField nameDDMFormField = new DDMFormField("name", "separator");

		DDMFormField firstNameDDMFormField = new DDMFormField(
			"FirstName", "text");
		DDMFormField lastNameDDMFormField = new DDMFormField(
			"LastName", "text");
		...
		//_ddmFormRendererImpl.populateDDMFormFieldRenderingContextStack(
			ddmForm.getDDMFormFields(), ddmFormFieldValuesMap, null,
			ddmFormFieldRenderingContextStack);

//		while (!ddmFormFieldRenderingContextStack.isEmpty()) {
//		//	System.out.println(
	ddmFormFieldRenderingContextStack.pop().getDDMFormField().getName());
//		}
	}
	...
	public void testCreateDDMFormFieldRenderingContextStackWithValues() {
		...
		DDMFormFieldValue firstNameDDMFormFieldValue = createDDMFormFieldValue(
			"firstName", new UnlocalizedValue("Joe"));
		DDMFormFieldValue lastNameDDMFormFieldValue = createDDMFormFieldValue(
			"lastName", new UnlocalizedValue("Bloggs"));

		DDMFormFieldValue nameDDMFormFieldValue = createDDMFormFieldValue(
			"name", null);

		nameDDMFormFieldValue.addNestedDDMFormFieldValue(
			firstNameDDMFormFieldValue);
		nameDDMFormFieldValue.addNestedDDMFormFieldValue(
			lastNameDDMFormFieldValue);

		DDMFormFieldValue phone1DDMFormFieldValue = createDDMFormFieldValue(
			"phone", new UnlocalizedValue("Phone 1"));
		DDMFormFieldValue ext1DDMFormFieldValue = createDDMFormFieldValue(
			"ext", new UnlocalizedValue("Ext 1"));

		phone1DDMFormFieldValue.addNestedDDMFormFieldValue(
			ext1DDMFormFieldValue);

		DDMFormFieldValue phone2DDMFormFieldValue = createDDMFormFieldValue(
			"phone", new UnlocalizedValue("Phone 2"));
		DDMFormFieldValue ext2DDMFormFieldValue = createDDMFormFieldValue(
			"ext", new UnlocalizedValue("Ext 2"));

		phone2DDMFormFieldValue.addNestedDDMFormFieldValue(
			ext2DDMFormFieldValue);

		DDMFormFieldValue contactDDMFormFieldValue = createDDMFormFieldValue(
			"contact", null);

		contactDDMFormFieldValue.addNestedDDMFormFieldValue(
			nameDDMFormFieldValue);
		contactDDMFormFieldValue.addNestedDDMFormFieldValue(
			phone1DDMFormFieldValue);
		contactDDMFormFieldValue.addNestedDDMFormFieldValue(
			phone2DDMFormFieldValue);
...
//		_ddmFormRendererImpl.populateDDMFormFieldRenderingContextStack(
	ddmForm.getDDMFormFields(), ddmFormValues.getDDMFormFieldValuesMap(), null,
	ddmFormFieldRenderingContextStack);
//
//		while (!ddmFormFieldRenderingContextStack.isEmpty()) {
//			System.out.println(
...
//		}
	...
	private DDMFormRendererImpl _ddmFormRendererImpl =
		new DDMFormRendererImpl();
}