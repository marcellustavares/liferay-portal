...
ddm.settings_form = function(opt_data, opt_ignored) {
  var output = '\t<div class="lfr-ddm-settings-form"><div class="tab-content">';
  ...
  for (var pageIndex126 = 0; pageIndex126 < pageListLen126; pageIndex126++) {
    ...
    output += '<div class="lfr-ddm-form-page ' + ((pageIndex126 == 0) ? 'active' : '') + '">' + ddm.form_rows(soy.$$augmentMap(opt_data, {rows: pageData126.rows})) + '</div>';
  }
  output += '</div></div>';
  return output;
};
