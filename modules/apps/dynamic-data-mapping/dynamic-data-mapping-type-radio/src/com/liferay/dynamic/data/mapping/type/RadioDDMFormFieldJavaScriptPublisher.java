...
@Component(
	property = {
		"osgi.http.whiteboard.resource.pattern=/ddm/radio/js/*",
		"osgi.http.whiteboard.resource.prefix=/META-INF/resources",
		"osgi.http.whiteboard.servlet.pattern=/ddm/radio/js/*"
	},
	immediate = true, service = Servlet.class
)
public class RadioDDMFormFieldJavaScriptPublisher extends HttpServlet {
