...
@Component(
	property = {
		"osgi.http.whiteboard.resource.pattern=/ddm/select/js/*",
		"osgi.http.whiteboard.resource.prefix=/META-INF/resources",
		"osgi.http.whiteboard.servlet.pattern=/ddm/select/js/*"
	},
	immediate = true, service = Servlet.class
)
public class SelectDDMFormFieldJavaScriptPublisher extends HttpServlet {
