...
public class TextboxDDMFormFieldType implements DDMFormFieldType {
	...
	public DDMFormFieldValueAccessor<String> getDDMFormFieldValueAccessor(
		...
		return new TextboxDDMFormFieldValueAccessor(locale);
	}
	...
	@Reference(service = TextboxDDMFormFieldRenderer.class, unbind = "-")
