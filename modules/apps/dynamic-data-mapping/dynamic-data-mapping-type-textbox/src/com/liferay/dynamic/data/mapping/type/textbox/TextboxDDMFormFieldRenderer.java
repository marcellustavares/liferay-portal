...
@Component(
	immediate = true,
	property = {"templatePath=/META-INF/resources/textbox.soy"},
	service = {TextboxDDMFormFieldRenderer.class, DDMFormFieldRenderer.class}
)
public class TextboxDDMFormFieldRenderer extends BaseDDMFormFieldRenderer {
