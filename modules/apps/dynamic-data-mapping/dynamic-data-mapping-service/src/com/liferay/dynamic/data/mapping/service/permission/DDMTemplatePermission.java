...
import com.liferay.dynamic.data.mapping.service.permission.DDMPermissionSupportTracker.DDMTemplatePermissionSupportWrapper;
...
public class DDMTemplatePermission {
	...
	public static void checkAddTemplatePermission(
		...
		if (!containsAddTemplatePermission(
			...
			DDMTemplatePermissionSupportWrapper
				templatePermissionSupportWrapper =
					_ddmPermissionSupportTracker.
						getDDMTemplatePermissionSupportWrapper(
							resourceClassNameId);

			throw new PrincipalException.MustHavePermission(
				permissionChecker,
				templatePermissionSupportWrapper.getPortletResourceName(
					classNameId),
				groupId, templatePermissionSupportWrapper.getAddActionId());
		}
	}
	...
	public static boolean containsAddTemplatePermission(
		...
		DDMTemplatePermissionSupportWrapper templatePermissionSupportWrapper =
			_ddmPermissionSupportTracker.getDDMTemplatePermissionSupportWrapper(
				resourceClassNameId);
	...
	public static String getTemplateModelResourceName(long resourceClassNameId)
		...
		return templatePermissionSupportWrapper.getModelResourceName();
	}
