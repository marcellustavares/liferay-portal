...
public class DDMDataProviderServiceHttp {
	...
	public static int searchCount(HttpPrincipal httpPrincipal, long companyId,
		...
		try {
			MethodKey methodKey = new MethodKey(DDMDataProviderServiceUtil.class,
					"searchCount", _searchCountParameterTypes2);
	...
	private static final Class<?>[] _searchParameterTypes0 = new Class[] {
	...
	private static final Class<?>[] _searchCountParameterTypes2 = new Class[] {
			long.class, long[].class, java.lang.String.class
		};
