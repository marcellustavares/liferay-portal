 ...
 */
public class DDMDataProviderFinderImpl
	extends DDMDataProviderFinderBaseImpl implements DDMDataProviderFinder {

	public static final String COUNT_BY_C_G_N_D =
		DDMDataProviderFinder.class.getName() + ".countByC_G_N_D";

	public static final String FIND_BY_C_G_N_D =
		DDMDataProviderFinder.class.getName() + ".findByC_G_N_D";
	...
	@Override
	public List<DDMDataProvider> filterByKeywords(
	...
	@Override
	public List<DDMDataProvider> findByKeywords(
		long companyId, long[] groupIds, String keywords, int start, int end,
		OrderByComparator<DDMDataProvider> orderByComparator) {
	...
	@Override
	public List<DDMDataProvider> filterFindByC_G_N_D(
		long companyId, long[] groupIds, String name, String description,
	...
	@Override
	public List<DDMDataProvider> findByC_G_N_D(
		long companyId, long[] groupIds, String name, String description,
		boolean andOperator, int start, int end,
		OrderByComparator<DDMDataProvider> orderByComparator) {
	...
	protected List<DDMDataProvider> doFindByC_G_N_D(
		...
		try {
			...
			if (inlineSQLHelper) {
				sql = InlineSQLHelperUtil.replacePermissionCheck(
					sql, DDMDataProvider.class.getName(),
					"DDMDataProvider.dataProviderId", groupIds);
			}

			sql = StringUtil.replace(
				sql, "[$GROUP_ID$]", getGroupIds(groupIds));
			sql = CustomSQLUtil.replaceKeywords(
				sql, "lower(DDMDataProvider.name)", StringPool.LIKE, false,
				names);
			sql = CustomSQLUtil.replaceKeywords(
				sql, "DDMDataProvider.description", StringPool.LIKE, true,
				descriptions);
			...
			q.addEntity("DDMDataProvider", DDMDataProviderImpl.class);
			...
			return (List<DDMDataProvider>)QueryUtil.list(
	...
	protected String getGroupIds(long[] groupIds) {
		...
		for (int i = 0; i < groupIds.length; i++) {
			sb.append("DDMDataProvider.groupId = ?");
