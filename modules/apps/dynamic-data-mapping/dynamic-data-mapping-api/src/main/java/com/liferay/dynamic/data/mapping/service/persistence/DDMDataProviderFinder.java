 ...
 */
@ProviderType
public interface DDMDataProviderFinder {
	...
	public java.util.List<com.liferay.dynamic.data.mapping.model.DDMDataProvider> filterByKeywords(
	...
	public java.util.List<com.liferay.dynamic.data.mapping.model.DDMDataProvider> findByKeywords(
		long companyId, long[] groupIds, java.lang.String keywords, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.mapping.model.DDMDataProvider> orderByComparator);

	public java.util.List<com.liferay.dynamic.data.mapping.model.DDMDataProvider> filterFindByC_G_N_D(
		long companyId, long[] groupIds, java.lang.String name,
		java.lang.String description, boolean andOperator, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.mapping.model.DDMDataProvider> orderByComparator);

	public java.util.List<com.liferay.dynamic.data.mapping.model.DDMDataProvider> findByC_G_N_D(
		long companyId, long[] groupIds, java.lang.String name,
		java.lang.String description, boolean andOperator, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.mapping.model.DDMDataProvider> orderByComparator);
}