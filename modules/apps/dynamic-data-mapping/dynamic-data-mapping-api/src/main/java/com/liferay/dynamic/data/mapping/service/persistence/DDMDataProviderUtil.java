...
public class DDMDataProviderUtil {
	...
	*/
	public static List<DDMDataProvider> filterFindByGroupId(long groupId) {
	...
	* @throws com.liferay.dynamic.data.mapping.NoSuchDataProviderException if a d d m data provider with the primary key could not be found
	*/
	public static DDMDataProvider[] filterFindByGroupId_PrevAndNext(
		long dataProviderId, long groupId,
		OrderByComparator<DDMDataProvider> orderByComparator)
		throws com.liferay.dynamic.data.mapping.exception.NoSuchDataProviderException {
		return getPersistence()
				   .filterFindByGroupId_PrevAndNext(dataProviderId, groupId,
			orderByComparator);
	}
	...
	* @return the matching d d m data providers that the user has permission to view
	*/
	public static List<DDMDataProvider> filterFindByGroupId(long[] groupIds) {
