...
public interface DDMDataProviderPersistence extends BasePersistence<DDMDataProvider> {
	...
	*/
	public java.util.List<DDMDataProvider> filterFindByGroupId(long groupId);
	...
	* @return the matching d d m data providers that the user has permission to view
	*/
	public java.util.List<DDMDataProvider> filterFindByGroupId(long[] groupIds);
	...
	* @return the range of matching d d m data providers that the user has permission to view
	*/
	public java.util.List<DDMDataProvider> filterFindByGroupId(
