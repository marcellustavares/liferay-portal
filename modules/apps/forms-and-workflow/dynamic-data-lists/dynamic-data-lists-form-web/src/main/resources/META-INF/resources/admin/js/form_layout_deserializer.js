		...
		var LayoutDeserializer = A.Component.create(
			{
				...
				prototype: {
					...
					_deserializeField: function(deserializedColumn, context) {
						...
						return new fieldClass(
							A.merge(
								...
								{
									context: context,
									getFieldTypeSettingFormContextURL: Liferay.DDL.ImmutableData.getFieldTypeSettingFormContextURL,
									parent: builder
								}
							)
						);
					...
					_deserializePage: function(page) {
						...
						instance.get('descriptions').push(page.descriptions);
						instance.get('titles').push(page.title);
