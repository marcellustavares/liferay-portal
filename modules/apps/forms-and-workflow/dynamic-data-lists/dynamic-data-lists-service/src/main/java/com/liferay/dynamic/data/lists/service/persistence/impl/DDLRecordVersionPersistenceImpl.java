...
public class DDLRecordVersionPersistenceImpl extends BasePersistenceImpl<DDLRecordVersion>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(DDLRecordVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDLRecordVersionModelImpl.FINDER_CACHE_ENABLED,
			DDLRecordVersionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(DDLRecordVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDLRecordVersionModelImpl.FINDER_CACHE_ENABLED,
			DDLRecordVersionImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			DDLRecordVersionModelImpl.UUID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(DDLRecordVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDLRecordVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DDLRecordVersion> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<DDLRecordVersion> findByUuid(String uuid, int start, int end) {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DDLRecordVersion ddlRecordVersion : list) {
					if (!Objects.equals(uuid, ddlRecordVersion.getUuid())) {
						list = null;
	 ...
	 */
	@Override
	public DDLRecordVersion findByUuid_First(String uuid,
		OrderByComparator<DDLRecordVersion> orderByComparator)
		throws NoSuchRecordVersionException {
		DDLRecordVersion ddlRecordVersion = fetchByUuid_First(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public DDLRecordVersion fetchByUuid_First(String uuid,
		OrderByComparator<DDLRecordVersion> orderByComparator) {
		List<DDLRecordVersion> list = findByUuid(uuid, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public DDLRecordVersion findByUuid_Last(String uuid,
		OrderByComparator<DDLRecordVersion> orderByComparator)
		throws NoSuchRecordVersionException {
		DDLRecordVersion ddlRecordVersion = fetchByUuid_Last(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public DDLRecordVersion fetchByUuid_Last(String uuid,
		OrderByComparator<DDLRecordVersion> orderByComparator) {
		...
		List<DDLRecordVersion> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	...
	public DDLRecordVersion[] findByUuid_PrevAndNext(long recordVersionId,
		String uuid, OrderByComparator<DDLRecordVersion> orderByComparator)
		throws NoSuchRecordVersionException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, ddlRecordVersion, uuid,
					orderByComparator, true);

			array[1] = ddlRecordVersion;

			array[2] = getByUuid_PrevAndNext(session, ddlRecordVersion, uuid,
	...
	protected DDLRecordVersion getByUuid_PrevAndNext(Session session,
		DDLRecordVersion ddlRecordVersion, String uuid,
	...
	public void removeByUuid(String uuid) {
		for (DDLRecordVersion ddlRecordVersion : findByUuid(uuid,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "ddlRecordVersion.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "ddlRecordVersion.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(ddlRecordVersion.uuid IS NULL OR ddlRecordVersion.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(DDLRecordVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDLRecordVersionModelImpl.FINDER_CACHE_ENABLED,
			DDLRecordVersionImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			DDLRecordVersionModelImpl.UUID_COLUMN_BITMASK |
			DDLRecordVersionModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(DDLRecordVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDLRecordVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public DDLRecordVersion findByUUID_G(String uuid, long groupId)
		throws NoSuchRecordVersionException {
		DDLRecordVersion ddlRecordVersion = fetchByUUID_G(uuid, groupId);
	 ...
	 */
	@Override
	public DDLRecordVersion fetchByUUID_G(String uuid, long groupId) {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((ddlRecordVersion.getUuid() == null) ||
							!ddlRecordVersion.getUuid().equals(uuid) ||
							(ddlRecordVersion.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
	 ...
	 */
	@Override
	public DDLRecordVersion removeByUUID_G(String uuid, long groupId)
		throws NoSuchRecordVersionException {
		DDLRecordVersion ddlRecordVersion = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "ddlRecordVersion.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "ddlRecordVersion.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(ddlRecordVersion.uuid IS NULL OR ddlRecordVersion.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "ddlRecordVersion.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(DDLRecordVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDLRecordVersionModelImpl.FINDER_CACHE_ENABLED,
			DDLRecordVersionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid_C",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(DDLRecordVersionModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { String.class.getName(), Long.class.getName() },
			DDLRecordVersionModelImpl.UUID_COLUMN_BITMASK |
			DDLRecordVersionModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(DDLRecordVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDLRecordVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DDLRecordVersion> findByUuid_C(String uuid, long companyId) {
	 ...
	 */
	@Override
	public DDLRecordVersion findByUuid_C_First(String uuid, long companyId,
		OrderByComparator<DDLRecordVersion> orderByComparator)
		throws NoSuchRecordVersionException {
		DDLRecordVersion ddlRecordVersion = fetchByUuid_C_First(uuid,
	 ...
	 */
	@Override
	public DDLRecordVersion fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator<DDLRecordVersion> orderByComparator) {
		List<DDLRecordVersion> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DDLRecordVersion findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<DDLRecordVersion> orderByComparator)
		throws NoSuchRecordVersionException {
		DDLRecordVersion ddlRecordVersion = fetchByUuid_C_Last(uuid, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public DDLRecordVersion fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<DDLRecordVersion> orderByComparator) {
		...
		List<DDLRecordVersion> list = findByUuid_C(uuid, companyId, count - 1,
	...
	public DDLRecordVersion[] findByUuid_C_PrevAndNext(long recordVersionId,
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, ddlRecordVersion, uuid,
					companyId, orderByComparator, true);

			array[1] = ddlRecordVersion;

			array[2] = getByUuid_C_PrevAndNext(session, ddlRecordVersion, uuid,
	...
	protected DDLRecordVersion getByUuid_C_PrevAndNext(Session session,
		DDLRecordVersion ddlRecordVersion, String uuid, long companyId,
		OrderByComparator<DDLRecordVersion> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (DDLRecordVersion ddlRecordVersion : findByUuid_C(uuid, companyId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(ddlRecordVersion);
		}
	}
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "ddlRecordVersion.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "ddlRecordVersion.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(ddlRecordVersion.uuid IS NULL OR ddlRecordVersion.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "ddlRecordVersion.companyId = ?";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C = new FinderPath(DDLRecordVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDLRecordVersionModelImpl.FINDER_CACHE_ENABLED,
			DDLRecordVersionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_C",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_C = new FinderPath(DDLRecordVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDLRecordVersionModelImpl.FINDER_CACHE_ENABLED,
			DDLRecordVersionImpl.class,
			...
			DDLRecordVersionModelImpl.GROUPID_COLUMN_BITMASK |
			DDLRecordVersionModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_C = new FinderPath(DDLRecordVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDLRecordVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public List<DDLRecordVersion> findByG_C(long groupId, long companyId,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DDLRecordVersion ddlRecordVersion : list) {
					if ((groupId != ddlRecordVersion.getGroupId()) ||
							(companyId != ddlRecordVersion.getCompanyId())) {
						list = null;
	...
	public DDLRecordVersion findByG_C_First(long groupId, long companyId,
		OrderByComparator<DDLRecordVersion> orderByComparator)
		throws NoSuchRecordVersionException {
		DDLRecordVersion ddlRecordVersion = fetchByG_C_First(groupId,
				companyId, orderByComparator);
	...
	public DDLRecordVersion fetchByG_C_First(long groupId, long companyId,
		OrderByComparator<DDLRecordVersion> orderByComparator) {
		List<DDLRecordVersion> list = findByG_C(groupId, companyId, 0, 1,
				orderByComparator);
	...
	public DDLRecordVersion findByG_C_Last(long groupId, long companyId,
		OrderByComparator<DDLRecordVersion> orderByComparator)
		throws NoSuchRecordVersionException {
		DDLRecordVersion ddlRecordVersion = fetchByG_C_Last(groupId, companyId,
				orderByComparator);
	...
	public DDLRecordVersion fetchByG_C_Last(long groupId, long companyId,
		...
		List<DDLRecordVersion> list = findByG_C(groupId, companyId, count - 1,
				count, orderByComparator);
	...
	public DDLRecordVersion[] findByG_C_PrevAndNext(long recordVersionId,
		...
		try {
			...
			array[0] = getByG_C_PrevAndNext(session, ddlRecordVersion, groupId,
					companyId, orderByComparator, true);

			array[1] = ddlRecordVersion;

			array[2] = getByG_C_PrevAndNext(session, ddlRecordVersion, groupId,
					companyId, orderByComparator, false);
	...
	protected DDLRecordVersion getByG_C_PrevAndNext(Session session,
		DDLRecordVersion ddlRecordVersion, long groupId, long companyId,
		OrderByComparator<DDLRecordVersion> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByG_C(long groupId, long companyId) {
		for (DDLRecordVersion ddlRecordVersion : findByG_C(groupId, companyId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(ddlRecordVersion);
		}
	}
	...
	private static final String _FINDER_COLUMN_G_C_GROUPID_2 = "ddlRecordVersion.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_COMPANYID_2 = "ddlRecordVersion.companyId = ?";
	...
	public void cacheResult(DDLRecordVersion ddlRecordVersion) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
			new Object[] {
				ddlRecordVersion.getUuid(), ddlRecordVersion.getGroupId()
			}, ddlRecordVersion);
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				ddlRecordVersionModelImpl.getUuid(),
				ddlRecordVersionModelImpl.getGroupId()
			};
	...
	protected void clearUniqueFindersCache(
		...
		if ((ddlRecordVersionModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					ddlRecordVersionModelImpl.getOriginalUuid(),
					ddlRecordVersionModelImpl.getOriginalGroupId()
				};
	...
	public DDLRecordVersion updateImpl(DDLRecordVersion ddlRecordVersion) {
		...
		if (Validator.isNull(ddlRecordVersion.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (ddlRecordVersion.getCreateDate() == null)) {
			if (serviceContext == null) {
				...
				ddlRecordVersion.setCreateDate(serviceContext.getCreateDate(now));
			}
		}

		if (!ddlRecordVersionModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				ddlRecordVersion.setModifiedDate(now);
			}
			else {
				ddlRecordVersion.setModifiedDate(serviceContext.getModifiedDate(
						now));
			}
		}
		...
		if (!DDLRecordVersionModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			Object[] args = new Object[] { ddlRecordVersionModelImpl.getUuid() };
			...
			args = new Object[] {
					ddlRecordVersionModelImpl.getUuid(),
					ddlRecordVersionModelImpl.getCompanyId()
				};
			...
			if ((ddlRecordVersionModelImpl.getColumnBitmask() &
				...
				args = new Object[] { ddlRecordVersionModelImpl.getUuid() };
			...
			if ((ddlRecordVersionModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						ddlRecordVersionModelImpl.getOriginalUuid(),
						ddlRecordVersionModelImpl.getOriginalCompanyId()
					};
	...
	protected DDLRecordVersion toUnwrappedModel(
		...
		ddlRecordVersionImpl.setUuid(ddlRecordVersion.getUuid());
		...
		ddlRecordVersionImpl.setModifiedDate(ddlRecordVersion.getModifiedDate());
		...
		ddlRecordVersionImpl.setLastPublishDate(ddlRecordVersion.getLastPublishDate());
