...
public class DDLRecordSetServiceUtil {
	...
	*/
	public static com.liferay.dynamic.data.lists.model.DDLRecordSet addRecordSet(
		...
		return getService()
				   .addRecordSet(groupId, ddmStructureVersionId, recordSetKey,
			nameMap, descriptionMap, minDisplayRows, scope, settings,
			serviceContext);
	}
	...
	*/
	public static com.liferay.dynamic.data.lists.model.DDLRecordSet updateRecordSet(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updateRecordSet(recordSetId, settingsDDMFormValues,
			serviceContext);
	}
