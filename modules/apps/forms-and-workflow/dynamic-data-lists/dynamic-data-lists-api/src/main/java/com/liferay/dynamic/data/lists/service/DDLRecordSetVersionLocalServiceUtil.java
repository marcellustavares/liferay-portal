...
public class DDLRecordSetVersionLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.dynamic.data.lists.model.DDLRecordSetVersion getDDLRecordSetVersion(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getDDLRecordSetVersion(recordSetId, version);
	}
	...
	*/
	...
	public static com.liferay.dynamic.data.lists.model.DDLRecordSetVersion getDLLRecordSetVersion(
		long recordSetVersionId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getDLLRecordSetVersion(recordSetVersionId);
	}
	...
	*/
	...
	public static int getDDLRecordSetVersionsCount(long recordSetId) {
		return getService().getDDLRecordSetVersionsCount(recordSetId);
	}
	...
	*/
	...
	public static java.util.List<com.liferay.dynamic.data.lists.model.DDLRecordSetVersion> getDDLRecordSetVersions(
		long recordSetId) {
		return getService().getDDLRecordSetVersions(recordSetId);
	}
	...
	public static java.util.List<com.liferay.dynamic.data.lists.model.DDLRecordSetVersion> getDDLRecordSetVersions(
		...
		return getService()
				   .getDDLRecordSetVersions(recordSetId, start, end,
			orderByComparator);
	}
