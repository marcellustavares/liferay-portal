...
public class VariablesEvaluationTest {
	...
	public void testIntegerVariable() throws Exception {
		DDMExpression<Integer> ddmExpression = new DDMExpressionImpl<>(
			"x * y", Integer.class);

		ddmExpression.setIntegerVariableValue("x", 1);
		ddmExpression.setIntegerVariableValue("y", 2);

		Assert.assertEquals(2, (int)ddmExpression.evaluate());
	}
	...
	public void testNestedVariables() throws Exception {
		...
		ddmExpression.setVariableValue("x", x);
	...
	public void testNumericVariable() throws Exception {
		...
		ddmExpression.setVariableValue("x", 1);
		ddmExpression.setVariableValue("y", 2);
