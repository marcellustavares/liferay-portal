 ...
 */
public abstract class BaseVisibilityFunction extends BasePropertyFunction {

	public BaseVisibilityFunction(
		Map<String, List<DDMFormFieldEvaluationResult>>
			ddmFormFieldEvaluationResults, boolean visible) {
	...
	public Object evaluate(Object... parameters) {
		...
		for (DDMFormFieldEvaluationResult formFieldEvaluationResult :
			...
			formFieldEvaluationResult.setVisible(_visible);
		}
