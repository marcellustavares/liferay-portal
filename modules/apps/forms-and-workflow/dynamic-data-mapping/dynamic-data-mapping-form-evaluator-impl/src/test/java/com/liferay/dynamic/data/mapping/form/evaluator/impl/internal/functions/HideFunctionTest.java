...
public class HideFunctionTest {
	...
	public void testEvaluate() throws Exception {
		...
		ddmFormFieldEvaluationResult1.setVisible(true);
		...
		HideFunction hideFunction = new HideFunction(
			ddmFormFieldEvaluationResults);

		hideFunction.evaluate("field0");
	...
	public void testEvaluateWithMultipleInstance() throws Exception {
		...
		ddmFormFieldEvaluationResult2.setVisible(true);
		...
		Assert.assertFalse(ddmFormFieldEvaluationResult1.isVisible());
		Assert.assertFalse(ddmFormFieldEvaluationResult2.isVisible());
	}
	...
	public void testEvaluateWithNoResultForField() throws Exception {
		...
		hideFunction.evaluate("not_available");
	...
	public void testIllegalArgument1() throws Exception {
		HideFunction hideFunction = new HideFunction(null);

		hideFunction.evaluate();
	}
	...
	public void testIllegalArgument2() throws Exception {
		...
		hideFunction.evaluate("param1", "param2");
	}
