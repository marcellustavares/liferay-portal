...
public class DDMStructureVersionPersistenceImpl extends BasePersistenceImpl<DDMStructureVersion>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(DDMStructureVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMStructureVersionModelImpl.FINDER_CACHE_ENABLED,
			DDMStructureVersionImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(DDMStructureVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMStructureVersionModelImpl.FINDER_CACHE_ENABLED,
			DDMStructureVersionImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			DDMStructureVersionModelImpl.UUID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(DDMStructureVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMStructureVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DDMStructureVersion> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<DDMStructureVersion> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<DDMStructureVersion> findByUuid(String uuid, int start,
		int end, OrderByComparator<DDMStructureVersion> orderByComparator) {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DDMStructureVersion ddmStructureVersion : list) {
					if (!Objects.equals(uuid, ddmStructureVersion.getUuid())) {
						list = null;
	 ...
	 */
	@Override
	public DDMStructureVersion findByUuid_First(String uuid,
		OrderByComparator<DDMStructureVersion> orderByComparator)
		throws NoSuchStructureVersionException {
		DDMStructureVersion ddmStructureVersion = fetchByUuid_First(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public DDMStructureVersion fetchByUuid_First(String uuid,
		OrderByComparator<DDMStructureVersion> orderByComparator) {
		List<DDMStructureVersion> list = findByUuid(uuid, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DDMStructureVersion findByUuid_Last(String uuid,
		OrderByComparator<DDMStructureVersion> orderByComparator)
		throws NoSuchStructureVersionException {
		DDMStructureVersion ddmStructureVersion = fetchByUuid_Last(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public DDMStructureVersion fetchByUuid_Last(String uuid,
		OrderByComparator<DDMStructureVersion> orderByComparator) {
		...
		List<DDMStructureVersion> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	...
	public DDMStructureVersion[] findByUuid_PrevAndNext(
		long structureVersionId, String uuid,
		OrderByComparator<DDMStructureVersion> orderByComparator)
		throws NoSuchStructureVersionException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, ddmStructureVersion,
					uuid, orderByComparator, true);

			array[1] = ddmStructureVersion;

			array[2] = getByUuid_PrevAndNext(session, ddmStructureVersion,
	...
	protected DDMStructureVersion getByUuid_PrevAndNext(Session session,
		DDMStructureVersion ddmStructureVersion, String uuid,
		OrderByComparator<DDMStructureVersion> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByUuid(String uuid) {
		for (DDMStructureVersion ddmStructureVersion : findByUuid(uuid,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "ddmStructureVersion.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "ddmStructureVersion.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(ddmStructureVersion.uuid IS NULL OR ddmStructureVersion.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(DDMStructureVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMStructureVersionModelImpl.FINDER_CACHE_ENABLED,
			DDMStructureVersionImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			DDMStructureVersionModelImpl.UUID_COLUMN_BITMASK |
			DDMStructureVersionModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(DDMStructureVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMStructureVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public DDMStructureVersion findByUUID_G(String uuid, long groupId)
		throws NoSuchStructureVersionException {
		DDMStructureVersion ddmStructureVersion = fetchByUUID_G(uuid, groupId);
	 ...
	 */
	@Override
	public DDMStructureVersion fetchByUUID_G(String uuid, long groupId) {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((ddmStructureVersion.getUuid() == null) ||
							!ddmStructureVersion.getUuid().equals(uuid) ||
							(ddmStructureVersion.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
	 ...
	 */
	@Override
	public DDMStructureVersion removeByUUID_G(String uuid, long groupId)
		throws NoSuchStructureVersionException {
		DDMStructureVersion ddmStructureVersion = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "ddmStructureVersion.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "ddmStructureVersion.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(ddmStructureVersion.uuid IS NULL OR ddmStructureVersion.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "ddmStructureVersion.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(DDMStructureVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMStructureVersionModelImpl.FINDER_CACHE_ENABLED,
			DDMStructureVersionImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(DDMStructureVersionModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { String.class.getName(), Long.class.getName() },
			DDMStructureVersionModelImpl.UUID_COLUMN_BITMASK |
			DDMStructureVersionModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(DDMStructureVersionModelImpl.ENTITY_CACHE_ENABLED,
			DDMStructureVersionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DDMStructureVersion> findByUuid_C(String uuid, long companyId) {
	 ...
	 */
	@Override
	public DDMStructureVersion findByUuid_C_First(String uuid, long companyId,
		OrderByComparator<DDMStructureVersion> orderByComparator)
		throws NoSuchStructureVersionException {
		DDMStructureVersion ddmStructureVersion = fetchByUuid_C_First(uuid,
	 ...
	 */
	@Override
	public DDMStructureVersion fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator<DDMStructureVersion> orderByComparator) {
		List<DDMStructureVersion> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DDMStructureVersion findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<DDMStructureVersion> orderByComparator)
		throws NoSuchStructureVersionException {
		DDMStructureVersion ddmStructureVersion = fetchByUuid_C_Last(uuid,
				companyId, orderByComparator);
	 ...
	 */
	@Override
	public DDMStructureVersion fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<DDMStructureVersion> orderByComparator) {
		...
		List<DDMStructureVersion> list = findByUuid_C(uuid, companyId,
	...
	public DDMStructureVersion[] findByUuid_C_PrevAndNext(
		long structureVersionId, String uuid, long companyId,
		OrderByComparator<DDMStructureVersion> orderByComparator)
		throws NoSuchStructureVersionException {
		DDMStructureVersion ddmStructureVersion = findByPrimaryKey(structureVersionId);
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, ddmStructureVersion,
					uuid, companyId, orderByComparator, true);

			array[1] = ddmStructureVersion;

			array[2] = getByUuid_C_PrevAndNext(session, ddmStructureVersion,
	...
	protected DDMStructureVersion getByUuid_C_PrevAndNext(Session session,
		DDMStructureVersion ddmStructureVersion, String uuid, long companyId,
		OrderByComparator<DDMStructureVersion> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (DDMStructureVersion ddmStructureVersion : findByUuid_C(uuid,
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "ddmStructureVersion.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "ddmStructureVersion.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(ddmStructureVersion.uuid IS NULL OR ddmStructureVersion.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "ddmStructureVersion.companyId = ?";
	...
	public void cacheResult(DDMStructureVersion ddmStructureVersion) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
			new Object[] {
				ddmStructureVersion.getUuid(), ddmStructureVersion.getGroupId()
			}, ddmStructureVersion);
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				ddmStructureVersionModelImpl.getUuid(),
				ddmStructureVersionModelImpl.getGroupId()
			};
	...
	protected void clearUniqueFindersCache(
		...
		if ((ddmStructureVersionModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					ddmStructureVersionModelImpl.getOriginalUuid(),
					ddmStructureVersionModelImpl.getOriginalGroupId()
				};
	...
	public DDMStructureVersion create(long structureVersionId) {
		...
		ddmStructureVersion.setUuid(uuid);
	...
	public DDMStructureVersion updateImpl(
		...
		if (Validator.isNull(ddmStructureVersion.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (ddmStructureVersion.getCreateDate() == null)) {
			if (serviceContext == null) {
				...
				ddmStructureVersion.setCreateDate(serviceContext.getCreateDate(
						now));
			}
		}

		if (!ddmStructureVersionModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				ddmStructureVersion.setModifiedDate(now);
			}
			else {
				ddmStructureVersion.setModifiedDate(serviceContext.getModifiedDate(
						now));
			}
		}
		...
		if (!DDMStructureVersionModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			Object[] args = new Object[] { ddmStructureVersionModelImpl.getUuid() };
			...
			args = new Object[] {
					ddmStructureVersionModelImpl.getUuid(),
					ddmStructureVersionModelImpl.getCompanyId()
				};
			...
			if ((ddmStructureVersionModelImpl.getColumnBitmask() &
				...
				args = new Object[] { ddmStructureVersionModelImpl.getUuid() };
			...
			if ((ddmStructureVersionModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						ddmStructureVersionModelImpl.getOriginalUuid(),
						ddmStructureVersionModelImpl.getOriginalCompanyId()
					};
	...
	protected DDMStructureVersion toUnwrappedModel(
		...
		ddmStructureVersionImpl.setUuid(ddmStructureVersion.getUuid());
		...
		ddmStructureVersionImpl.setModifiedDate(ddmStructureVersion.getModifiedDate());
		...
		ddmStructureVersionImpl.setLastPublishDate(ddmStructureVersion.getLastPublishDate());
