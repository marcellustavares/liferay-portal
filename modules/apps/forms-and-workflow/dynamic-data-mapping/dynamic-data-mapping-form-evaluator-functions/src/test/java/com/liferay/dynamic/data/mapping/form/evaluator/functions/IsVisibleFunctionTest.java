 ...
 */
public class IsVisibleFunctionTest {

	@Test
	public void testEvaluateFalse() throws Exception {
		IsVisibleFunction isVisibleFunction = new IsVisibleFunction();

		isVisibleFunction.attach(
		...
		Assert.assertFalse((Boolean)isVisibleFunction.evaluate("field1"));
	}
	...
	public void testEvaluateInvalid() throws Exception {
		...
		isVisibleFunction.evaluate("test", "test2");
	}
	...
	public void testEvaluateInvalid2() throws Exception {
		...
		isVisibleFunction.evaluate("invalid field name");
	}
	...
	public void testEvaluateTrue() throws Exception {
		...
		Assert.assertTrue((Boolean)isVisibleFunction.evaluate("field1"));
	}
