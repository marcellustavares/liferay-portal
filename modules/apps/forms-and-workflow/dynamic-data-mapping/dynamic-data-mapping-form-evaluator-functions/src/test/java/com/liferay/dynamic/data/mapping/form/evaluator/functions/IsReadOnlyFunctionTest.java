 ...
 */
public class IsReadOnlyFunctionTest {

	@Test
	public void testEvaluateFalse() throws Exception {
		IsReadOnlyFunction isReadOnlyFunction = new IsReadOnlyFunction();

		isReadOnlyFunction.attach(
		...
		Assert.assertFalse((Boolean)isReadOnlyFunction.evaluate("field1"));
	}
	...
	public void testEvaluateInvalid() throws Exception {
		...
		isReadOnlyFunction.evaluate("test", "test2");
	}
	...
	public void testEvaluateInvalid2() throws Exception {
		...
		isReadOnlyFunction.evaluate("invalid field name");
	}
	...
	public void testEvaluateTrue() throws Exception {
		...
		Assert.assertTrue((Boolean)isReadOnlyFunction.evaluate("field1"));
	}
