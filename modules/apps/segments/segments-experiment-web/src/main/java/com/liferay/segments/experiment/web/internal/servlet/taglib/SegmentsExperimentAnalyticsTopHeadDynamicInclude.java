...
public class SegmentsExperimentAnalyticsTopHeadDynamicInclude
	...
	private Map<String, String> _getAnalyticsContextMap(
		SegmentsExperiment segmentsExperiment,
		...
		if (segmentsExperiment == null) {
			...
			replaceMap.put("experimentId", StringPool.BLANK);
			replaceMap.put("variantId", StringPool.BLANK);
		...
		replaceMap.put("variantId", segmentsExperimentSegmentsExperienceKey);
