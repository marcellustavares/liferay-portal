			...
			<liferay-ui:section>
				<div class="sidebar-body">
					...
					<liferay-ui:panel-container cssClass="metadata-panel-container" extended="<%= true %>" markupView="lexicon" persistState="<%= true %>">
						...
						<liferay-custom-field-ui:custom-attribute-available className="<%= DLFileEntryConstants.getClassName() %>" classPK="<%= fileVersionId %>" editable="<%= false %>">
						...
						</liferay-custom-field-ui:custom-attribute-available>
