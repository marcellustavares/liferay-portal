...
update WikiNode set statusDate = modifiedDate;alter table Account_ add mvccVersion LONG default 0;
alter table Address add mvccVersion LONG default 0;
alter table BackgroundTask add mvccVersion LONG default 0;
alter table BrowserTracker add mvccVersion LONG default 0;
alter table ClassName_ add mvccVersion LONG default 0;
alter table ClusterGroup add mvccVersion LONG default 0;
alter table Company add mvccVersion LONG default 0;
alter table Contact_ add mvccVersion LONG default 0;
alter table Country add mvccVersion LONG default 0;
alter table EmailAddress add mvccVersion LONG default 0;
alter table ExportImportConfiguration add mvccVersion LONG default 0;
alter table Group_ add mvccVersion LONG default 0;
alter table Image add mvccVersion LONG default 0;
alter table Layout add mvccVersion LONG default 0;
alter table LayoutBranch add mvccVersion LONG default 0;
alter table LayoutFriendlyURL add mvccVersion LONG default 0;
alter table LayoutPrototype add mvccVersion LONG default 0;
alter table LayoutRevision add mvccVersion LONG default 0;
alter table LayoutSet add mvccVersion LONG default 0;
alter table LayoutSetBranch add mvccVersion LONG default 0;
alter table LayoutSetPrototype add mvccVersion LONG default 0;
alter table ListType add mvccVersion LONG default 0;
alter table Lock_ add mvccVersion LONG default 0;
alter table MembershipRequest add mvccVersion LONG default 0;
alter table Organization_ add mvccVersion LONG default 0;
alter table OrgGroupRole add mvccVersion LONG default 0;
alter table OrgLabor add mvccVersion LONG default 0;
alter table PasswordPolicy add mvccVersion LONG default 0;
alter table PasswordPolicyRel add mvccVersion LONG default 0;
alter table PasswordTracker add mvccVersion LONG default 0;
alter table Phone add mvccVersion LONG default 0;
alter table PluginSetting add mvccVersion LONG default 0;
alter table PortalPreferences add mvccVersion LONG default 0;
alter table Portlet add mvccVersion LONG default 0;
alter table PortletItem add mvccVersion LONG default 0;
alter table PortletPreferences add mvccVersion LONG default 0;
alter table Region add mvccVersion LONG default 0;
alter table Release_ add mvccVersion LONG default 0;
alter table Repository add mvccVersion LONG default 0;
alter table RepositoryEntry add mvccVersion LONG default 0;
alter table ResourceAction add mvccVersion LONG default 0;
alter table ResourceBlock add mvccVersion LONG default 0;
alter table ResourceBlockPermission add mvccVersion LONG default 0;
alter table ResourcePermission add mvccVersion LONG default 0;
alter table ResourceTypePermission add mvccVersion LONG default 0;
alter table Role_ add mvccVersion LONG default 0;
alter table ServiceComponent add mvccVersion LONG default 0;
alter table Shard add mvccVersion LONG default 0;
alter table Subscription add mvccVersion LONG default 0;
alter table SystemEvent add mvccVersion LONG default 0;
alter table Team add mvccVersion LONG default 0;
alter table Ticket add mvccVersion LONG default 0;
alter table UserNotificationDelivery add mvccVersion LONG default 0;
alter table User_ add mvccVersion LONG default 0;
alter table UserGroup add mvccVersion LONG default 0;
alter table UserGroupGroupRole add mvccVersion LONG default 0;
alter table UserGroupRole add mvccVersion LONG default 0;
alter table UserIdMapper add mvccVersion LONG default 0;
alter table UserNotificationEvent add mvccVersion LONG default 0;
alter table UserTracker add mvccVersion LONG default 0;
alter table UserTrackerPath add mvccVersion LONG default 0;
alter table VirtualHost add mvccVersion LONG default 0;
alter table WebDAVProps add mvccVersion LONG default 0;
alter table Website add mvccVersion LONG default 0;
alter table WorkflowDefinitionLink add mvccVersion LONG default 0;
alter table WorkflowInstanceLink add mvccVersion LONG default 0;
