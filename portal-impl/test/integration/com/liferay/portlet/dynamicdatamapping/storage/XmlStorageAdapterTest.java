...
public class XmlStorageAdapterTest extends BaseStorageAdapterTest {

	@Override
	public StorageAdapter getStorageAdapter() {

		return _xmlStorageAdapater;
	}
	...
	public void testBooleanField() throws Exception {
		...
		DDMStructure structure = addStructure(_classNameId, null,
			"Boolean Field Structure", xsd,StorageType.XML.getValue(),
	...
	public void testDateField() throws Exception {
		...
		DDMStructure structure =
			addStructure(
				_classNameId, null, "Date Field Structure", xsd, StorageType.XML
	...
	public void testTextField() throws Exception {
		...
		DDMStructure structure =
			addStructure(
				_classNameId, null, "Text Field Structure", xsd, StorageType.XML
					.getValue(), DDMStructureConstants.TYPE_DEFAULT);
	...
	protected StorageAdapter _xmlStorageAdapater = new XMLStorageAdapter();
