...
* @author Adolfo Pérez
*/
final class FieldNameDDMQueryMatcher implements DDMQueryMatcher {

	public FieldNameDDMQueryMatcher(String name, DDMQueryMatcher matcher) {
		_name = name;
		_matcher = matcher;
	}
	...
	public DDMFormFieldValue match(DDMFormFieldValue ddmFormFieldValue) {
		if (ddmFormFieldValue.getName().equals(_name)) {
